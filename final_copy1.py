...
class MainWindow():
    ...
    def __init__(self, master):
        ...
        self.tkimage = ImageTk.PhotoImage(file="robot.jpg")
    ...
    def userinput(self):
        ...
        "i wanna arrange a meeting","I want you to arrange a meeting for me","arrange meeting"}:
            self.arrangeMeeting()
